...
def auto_scale_block(module, module_kwargs, w_bit, q_config, input_feat, ans_mask):
    ...
    def _search_module_scale(block, linears2scale: list, x, kwargs={}):
        ...
        # Normalize in fp32.  In fp16, scales.max() * scales.min() may
        # overflow even when both operands are finite; the resulting zero
        # divisor later turns otherwise finite weights into Inf/NaN.
